...
fooled_by: "PSNR/MSE prefer a detail-destroying BLUR over a sharp image with a tiny (2px) shift; 'looks sharp' (tier A) and PSNR (naive C) both mis-rank"
...
source: "classic perceptual-metric result (Zhang et al. 2018, LPIPS); included here as a RUNNABLE proof that the right tier-C gauge beats both naive metrics and eyeballing"
---
